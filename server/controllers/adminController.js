...
exports.addFaculty = async (req, res, next) => {
  try {
    ...
    console.log("Faculty Data:", { name, email, designation, department, facultyMobileNumber });
    ...
    let hashedPassword;
    console.log("Password from .env:", process.env.FACULTY_PASSWORD);
    ...
    console.error("Error in adding new Faculty:", err.message);
    res
      .status(400)
