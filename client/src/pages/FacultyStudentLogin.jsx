            ...
            <Right>
                {
                   isStudentLogin? (
                       <LoginBox>
                           <LoginInput placeholder="Student ID Number" type="text" onChange={(e) => setStudentRegNum(e.target.value)} required/>
                      ...
                      <LoginBox>
                           <LoginInput placeholder="Faculty ID Number" onChange={(e) => setFacultyRegNum(e.target.value)} type="text" required/>
                       ...
                       <LoginInfo>
                           <Link to="/forgotPassword/faculty">
                           Forgot Password?
                           </Link>
                       </LoginInfo>
                      </LoginBox>
