...
const StudentUpdateProfile = () => {
    ...
    const imageHandler = (e) => {
        ...
        setAvatar(file); // Storing the file, not base64
        ...
        <Container>
            <ProfileBox>
                ...
                <ProfileForm encType='multiform/form-data' onSubmit={fileHandler}>
                    ...
                    <ProfilePhone>
                        <Phone/>
                        <ProfileInput type="text" placeholder="Student Mobile" required name="studentMobileNumber" value={mobile}  onChange={(e) => setMobile(e.target.value)}/>
                    </ProfilePhone>
                    <ProfileName>
                        <SupervisorAccount/>
